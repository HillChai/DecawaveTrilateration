...
def leastSquaresMethod(bestSolution: list, anchorPos: list, distances: list) -> int:
    # Matrix * pos^T = b^T
    noValidDistances = 0
    ...
    bestSolution[0] = x_pos
    bestSolution[1] = y_pos
    bestSolution[2] = z_pos
...
leastSquaresMethod(bestLocation, anchorPos, distances)
print(bestLocation)
